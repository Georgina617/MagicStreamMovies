...
const useAxiosPrivate = () => {
  ...
  useEffect(() => {
    // Request interceptor: attach Authorization header when we have a token
    ...
    const respInterceptor = axiosAuth.interceptors.response.use(
      (response) => response,
      async (error) => {
    ...
    return () => {
      ...
      axiosAuth.interceptors.response.eject(respInterceptor);
    };
  }, [auth]);
